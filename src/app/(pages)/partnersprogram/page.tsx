...
import VideoSection from "@/app/(frontend)/components/value";
import React from "react";
import Button from "@/app/(frontend)/components/buttons";
const CirclesImage = () => {
  return (
    <div className="elementor-element elementor-widget elementor-widget-image">
      <div>
        <div className="relative w-full h-screen">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-teal-500-300 to-gray-300 opacity-60"></div>

          <div className="relative z-10 flex flex-col items-center justify-center gap-10 h-full">
            <div className="items-center justify-center flex flex-col">
              <h1 className="text-white text-5xl font-extrabold">
                Join & Grow with Resourceinns Partners{" "}
              </h1>
              <h1 className="text-white text-5xl font-extrabold">Program</h1>
            </div>
            <div className="items-center justify-center flex flex-col">
              <h1 className="text-white text-lg w-[800px]">
                Let’s join together and help growing SMEs and enterprises make
                employment easier than ever before. Resourceinn simplifies HR
                and lets businesses adapt to changes in their needs as they{" "}
              </h1>
            ...
            <div>
              <img
                className="w-[400px]"
                src="https://resourceinn.com/wp-content/uploads/2022/12/partner-plan-01.webp"
                alt=""
              />
            </div>
          </div>
