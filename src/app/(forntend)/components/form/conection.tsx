    ...
    <div className=' flex justify-center items-center p-20 bg-gradient-to-b  from-purple-800 to-purple-500  w-full'>
      ...
      <div className='rounded-r-3xl p-10 bg-white flex flex-col justify-center items-center'>
        ...
        <form onSubmit={handlesubmit} className=' flex flex-col gap-5' action="post">
            ...
            <input onChange={(e)=> setName(e.target.value)} required className='focus:outline-3 focus:outline-blue-700  h-[40px] pl-3 rounded-sm border-2 border-gray-400 w-[250px]' type="text" name='Name' />
            </div>
            <div className=''>
            <p className='mb-1'>Email</p>
            <input onChange={(e)=> setEmail(e.target.value)} required className='h-[40px] focus:outline-3 focus:outline-blue-700 pl-3 rounded-sm border-2 border-gray-400 w-[250px]' type="text" name='Name' />
            </div>
            </div>
            <div className='flex gap-5'>
            <div className=''>
            <p  className='mb-1'>Phone Number</p>
            <input onChange={(e)=> setPhonenumber(e.target.value)} required className='focus:outline-3 focus:outline-blue-700 h-[40px] pl-3 rounded-sm border-2 border-gray-400 w-[250px]' type="text" name='Name' />
            </div>
            <div className=''>
            <p className='mb-1'>Company Name</p>
            <input required onChange={(e)=> setCompanyname(e.target.value)} className='focus:outline-3 focus:outline-blue-700 h-[40px] pl-3 rounded-sm border-2 border-gray-400 w-[250px]' type="text" name='Name' />
            </div>
            </div>
            <div>
                <p className='mb-1'>Tell us about your requirements</p>
                <textarea onChange={(e)=> setComment(e.target.value)} className='focus:outline-3 focus:outline-blue-700 rounded-sm p-3 border-gray-400  border-2 w-full h-[150px]' name="area" id="area"></textarea>
            </div>
